The goal is to create 100 small Python 'apps' / 'projects', from begginer levels all the way to Intermediate, then to Advanced and to building a PRO Python portfolio.
